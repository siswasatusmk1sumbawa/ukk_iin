      ...
      <div class="col-sm-3 bg-body-tertiary">
        ...
        <form action="foto.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="judulfoto" placeholder="Judul Foto" name="judulfoto">
          </div>
          <div class="mb-3">
            <label for="deskripsifoto">Deskripsi Foto</label>
            <textarea name="deskripsifoto" id="deskripsifoto" class="form-control" rows="5" placeholder="deskripsi foto"></textarea>
          </div>
          <div class="mb-3">
